...
| **02** | [`02-footer-pattern-and-styling.md`](02-footer-pattern-and-styling.md) | `Pending` | Footer pattern shortcode integration (`[mc4wp_form]`), CSS styling for `.mc4wp-form` and alerts, JS submission handling |
| **03** | [`03-confirmation-email-hook.md`](03-confirmation-email-hook.md) | `Pending` | LakeHub branded HTML confirmation email via `mc4wp_form_subscribed` hook with dynamic admin email sender |
