...
| **05** | [`05-program-card-directional-scroll.md`](05-program-card-directional-scroll.md) | `Complete` | Directional fade/slide for program cards (bottom-right on scroll-down, top-right on scroll-up) |
