...
| **02** | [`02-halftone-grid-sizing-and-offsets.md`](02-halftone-grid-sizing-and-offsets.md) | `Pending` | 28px dot pitch tile, exact image frame matching across all viewports, section-specific offsets |
