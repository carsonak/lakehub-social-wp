...
| **02** | [`02-collapsible-story-read-more-hide.md`](02-collapsible-story-read-more-hide.md) | `In Progress` | Collapsible "Read More / Hide" with thick chevron arrow (`down.png`), bottom fade-out after paragraph 1 |
| **03** | [`03-scrolling-logos-hover-and-edge-padding.md`](03-scrolling-logos-hover-and-edge-padding.md) | `Pending` | Restrict pause trigger to logos track only; remove side padding completely (`padding-inline: 0`) |
| **04** | [`04-inspiring-portfolios-and-coming-soon-cleanup.md`](04-inspiring-portfolios-and-coming-soon-cleanup.md) | `Pending` | Route "View More Stories" to `/coming-soon/`; remove redundant "EXPLORE PROGRAMS" button |
