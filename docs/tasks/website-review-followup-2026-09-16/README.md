...
| **03** | [`03-scrolling-logos-hover-and-edge-padding.md`](03-scrolling-logos-hover-and-edge-padding.md) | `In Progress` | Restrict pause trigger to logos track only; remove side padding completely (`padding-inline: 0`) |
