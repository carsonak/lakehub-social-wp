...
| **05** | [`05-metric-numbers-and-nav-bar-hover-interactivity.md`](05-metric-numbers-and-nav-bar-hover-interactivity.md) | `In Progress` | Scale metrics by 0.75; nav-bar style hover (lift 2px, underline, transparent bg) for text buttons and footer links |
