...
| **06** | [`06-interactive-newsletter-form.md`](06-interactive-newsletter-form.md) | `In Progress` | Convert static newsletter mock to interactive email `<input>` with dark ghost placeholder and submit button |
