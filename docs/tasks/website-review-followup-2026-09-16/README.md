...
| **04** | [`04-inspiring-portfolios-and-coming-soon-cleanup.md`](04-inspiring-portfolios-and-coming-soon-cleanup.md) | `Complete` | Route "View More Stories" to `/coming-soon/`; remove redundant "EXPLORE PROGRAMS" button |
| **05** | [`05-metric-numbers-and-nav-bar-hover-interactivity.md`](05-metric-numbers-and-nav-bar-hover-interactivity.md) | `Complete` | Scale metrics by 0.75; nav-bar style hover (lift 2px, underline, transparent bg) for text buttons and footer links |
| **06** | [`06-interactive-newsletter-form.md`](06-interactive-newsletter-form.md) | `Complete` | Convert static newsletter mock to interactive email `<input>` with dark ghost placeholder and submit button |
| **07** | [`07-verification-and-regression-suite.md`](07-verification-and-regression-suite.md) | `In Progress` | Playwright test suite for all 9 refinements, PHP linting, shellcheck, visual inspection |
