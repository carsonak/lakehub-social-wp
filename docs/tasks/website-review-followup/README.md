...
| **04** | [`04-mission-vision-right-border-anchoring.md`](04-mission-vision-right-border-anchoring.md) | `Complete` | "Mission & Vision": Anchor center of big diamond 26.5px inside right border; eliminate viewport drift across desktop and tablet |
