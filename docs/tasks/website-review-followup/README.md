...
| **02** | [`02-viewport-quarter-scroll-triggers.md`](02-viewport-quarter-scroll-triggers.md) | `Pending` | 1/4 (25%) viewport threshold triggers for Impact metrics and Our Other Programs scroll animations |
