...
| **02** | [`02-local-and-git-workspace-pruning.md`](02-local-and-git-workspace-pruning.md) | `Pending` | Delete local backups older than Monday 2026-09-14, remove `.runtime/mysql/`, pack loose Git objects (`git gc`) |
