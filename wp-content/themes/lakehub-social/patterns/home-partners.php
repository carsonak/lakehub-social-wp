...
/**
 * Title: Home · Partners
 * Slug: lakehub-social/home-partners
 * Categories: lakehub
 * Description: Editable Figma-based LakeHub layout.
 */
?>
<!-- wp:group {"tagName":"section","templateLock":"all","metadata":{"name":"Home · Partners"},"align":"full","className":"is-style-lakehub-partners","backgroundColor":"teal","layout":{"type":"default"}} -->
<section class="wp-block-group alignfull is-style-lakehub-partners has-teal-background-color has-background"><!-- wp:paragraph {"align":"center","textColor":"muted","fontSize":"caption","fontFamily":"mono"} -->
<p class="has-muted-color has-text-color has-mono-font-family has-caption-font-size">TRUSTED BY ORGANIZATIONS GLOBALLY</p>
<!-- /wp:paragraph -->
